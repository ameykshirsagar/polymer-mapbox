...
class MapboxGlPopup extends PolymerElement {
    ...
    static get properties() {
        return {
            ...
            popup: {
                type: Object,
                notify: true,
                computed: '_createPopup(map, closeButton, closeOnClick, offset, top, topLeft, topRight, bottom, bottomLeft, bottomRight, left, right)'
            },
            /**
            ...
            _childrenObserver: FlattenedNodesObserver,
            _container: Object,
    ...
    static get observers() {
        return [
            '_attachedPopup(popup, opened, attachToMarker)',
...
window.customElements.define('mapbox-gl-popup', MapboxGlPopup);